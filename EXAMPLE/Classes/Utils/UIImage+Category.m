...
- (CGSize) pointSize {
    CGFloat heightInPoints = self.size.height;
    CGFloat widthInPoints = self.size.width;
    return CGSizeMake(widthInPoints, heightInPoints);
}

- (CGSize) pixelSize {
    CGFloat heightInPixels = self.size.height * self.scale;
    CGFloat widthInPixels = self.size.width * self.scale;
